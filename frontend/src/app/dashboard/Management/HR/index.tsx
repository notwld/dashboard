        ...
        <div className="grid grid-cols-3 p-4 gap-5">
                  ...
                  {leaveBalance.length > 0 ? (
                    leaveBalance.map((entry, index) => (
                      ...
                      >
                        ...
                        <span>{entry?.leaveBalance} Leaves</span>
                      </div>
                    ))
                  ) : (
          ...
          <Card className="h-64 ring-2 ring-green-600">
            <CardHeader>
              ...
              <CardDescription>Top Employees of the Month</CardDescription>
            </CardHeader>
            <CardContent>
              <ScrollArea className="h-48 rounded-md w-full">
                <div className="flex flex-col gap-3">
          ...
          <Tabs defaultValue="account" className="col-span-3 w-full">
            <TabsList className="w-full py-10 justify-center items-center">
              <TabsTrigger value="account" className="py-5 w-[50%] text-lg">
                Leaves
              </TabsTrigger>
              <TabsTrigger value="password" className="py-5 w-[50%] text-lg">
                Absentees
              </TabsTrigger>
            </TabsList>
                ...
                <CardContent className="my-5">
                  {absentees.length > 0 ? (
                    absentees.map((entry, index) => (
                      <div
                        key={index}
                        className="bg-slate-700 flex justify-between items-center py-4 px-5 rounded-lg my-2 cursor-pointer hover:bg-slate-800"
                      >
                        <span>
          ...
          <Card className="col-span-3">
            <CardHeader>
              ...
              <CardDescription>Employees and their Status</CardDescription>
            </CardHeader>
            <CardContent>
              <EmployeesTable />
            </CardContent>
